...
from recipe.domain_model.author import Author
from recipe.domain_model.recipe import Recipe
...
def create_recipes() -> list[Recipe]:
    ...
    recipe2 = Recipe(10327, 'World\'s Best Potato Salad', author2,
                     ...
                     ingredients=["white potatoes", "celery", "dill pickle", "pitted black olives", "medium cheddar",
                                  "swiss cheese", "parmesan cheese", "red onion", "garlic", "white pepper",
                                  "ground black pepper", "dry mustard", "cayenne pepper", "mayonnaise"],
                     instructions=[
    ...
    recipe3 = Recipe(9446, 'Ham and Cheese Pie', author3,
                     ...
                     ingredients=["baking potato", "onion", "butter", "milk", "egg", "dry mustard", "ground cloves",
                                  "low-salt ham", "cheddar cheese", "butter", "flour", "white pepper", "ground nutmeg",
                                  "cayenne pepper", "milk", "cheddar cheese"],
                     instructions=[
                         ...
                         'Return to heat and cook until thick and bubbly.', 'Stir in cheese and cook until melted.'],
                     images=[
...
def create_app():
    ...
    @app.route('/browse')
    def browse():
        return render_template('browse.html', recipes=list_recipes)

    @app.route('/recipe/<int: recipe_id')
    def recipe(recipe_id):
        r = next(recipe for recipe in list_recipes if recipe.id == recipe_id)
